...
public struct Basic_VertexDescriptor: VertexDescriptor{
    ...
    init(){
        ...
        vertexDescriptor.attributes[4].offset = float3.size + float4.size + float2.size + float3.size
        
        //Bitangent
        vertexDescriptor.attributes[5].format = .float3
        vertexDescriptor.attributes[5].bufferIndex = 0
        vertexDescriptor.attributes[5].offset = float3.size + float4.size + float2.size + float3.size + float3.size
